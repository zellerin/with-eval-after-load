...
This package imitates the with-eval-after-load macro."
  ...
  (@example mgl-pax:section)
  (@dictionary mgl-pax:section)
  (@bugs mgl-pax:section)
)

(mgl-pax:defsection @example
    (:title "Quick start example")
  " Drakma by default considers Javascript to be a binary
...
(mgl-pax:defsection @bugs
    (:title "Known bugs")
  "This is in \"good-enough-for-me\" state."
  "It abuses ASDF:PERFORM :AFTER method. If some system uses it, things may break. That said, I did not see it defined on the systems I use.")
